...
date_slider = st.sidebar.slider( 
    'Até qual valor?',
        value=pd.to_datetime( '2022, 4, 6', yearfirst= True, format='DD-MM-YYYY'),
    min_value=pd.to_datetime('2022, 2, 11', yearfirst= True, format='DD-MM-YYYY' ),
    max_value=pd.to_datetime( '2022, 4, 6',yearfirst= True, format='DD-MM-YYYY' ))
